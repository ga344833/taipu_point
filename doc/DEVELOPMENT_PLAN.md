...
## 第一階段：核心業務邏輯與 API 實作 (Day 2-3)

**目標**：完成店家上架與會員兌換的「最簡可行產品 (MVP)」路徑。

### 店家商品管理 API (Store App)

#### 實作項目
- [ ] 商品的 CRUD（建立、讀取、更新、刪除）
  - [ ] 建立商品 API
  - [ ] 查詢商品列表 API
  - [ ] 查詢單一商品 API
  - [ ] 更新商品 API
...
- [ ] 整合 drf-spectacular
  ...
  - [ ] 設定 API 文件端點（`/api/docs/` 與 `/api/redoc/`）
